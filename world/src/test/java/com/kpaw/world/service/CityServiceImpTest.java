...
class CityServiceImpTest {
    ...
    @Test
    void searchBy() {
        given(cityRepository.findByNameContainsAndCountryNameContainsAllIgnoreCase("city", "country")).willReturn(cities);
    ...
    void orderByName() {
        service.orderByName();
        then(cityRepository).should().findAllByOrderByNameAsc();
    ...
    void orderByCountry() {
        ...
        then(cityRepository).should().findAllByOrderByCountryNameAsc();
    }

    @Test
    void orderByPopulation() {
        service.orderByPopulation();
        then(cityRepository).should().findAllByOrderByPopulationAsc();
    }
